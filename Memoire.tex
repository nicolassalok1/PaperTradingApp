...
%================= Titre ======================
\title{\vspace{-2cm}%
    \textbf{PaperTradingApp : Finance de march\'e, mod\'elisation de la volatilit\'e et gestion du risque}\\[0.3cm]
    \large M\'emoire de synth\`ese --- notions th\'eoriques et mise en perspective
}
\author{Pr\'enom Nom}
\date{\today}
...
Parall\`element, les m\'ethodes d'apprentissage (\emph{supervised learning}, r\'eduction dimensionnelle,
apprentissage par renforcement) apportent des outils pour la calibration, l'approximation de surfaces,
l'identification de r\'egimes et la d\'ecision s\'equentielle (par exemple pour la couverture sous co\^uts
de transaction).
...
Dans ce qui suit, la \textbf{Partie 1} d\'eveloppe les fondements de finance quantitative utiles au projet
(pricing, volatilit\'e, couverture, courbes de taux, calibration). La \textbf{Partie 2} pr\'esente les notions
d'apprentissage pertinentes pour la calibration/surrogates et la d\'ecision s\'equentielle. La \textbf{Partie 3}
fait la synth\`ese du projet \emph{PaperTradingApp} sous la forme d'une cartographie des modules et des notions,
afin de rendre explicite le lien entre th\'eorie et objectifs. La \textbf{Partie 4} conclut et ouvre sur des
extensions naturelles. Enfin, la \textbf{Partie 5} rassemble la bibliographie et des ressources.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{1.8. Gestion du risque de portefeuille et allocation}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{1.8.1. PnL, expositions et drawdowns}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{1.8.2. Value-at-Risk (VaR) et Expected Shortfall (ES)}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{1.8.3. Allocation moyenne--variance (Markowitz)}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{1.8.4. Risk parity et contributions au risque}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{1.8.5. PCA et eigen-portfolios}
...
%==========================================================
\section{3. Projet : PaperTradingApp}
...
%----------------------------------------------------------
\subsection{3.1. Objectifs, p\'erim\`etre et hypoth\`eses}
...
\subsection{3.2. Donn\'ees de march\'e : qualit\'e, horizons et coh\'erence}
...
\subsection{3.3. Options : pricing, volatilit\'e implicite et surfaces}
...
\subsection{3.4. Calibration avanc\'ee : du smile au mod\`ele}
...
\subsection{3.5. Courbe des taux : discounting, forwards, param\'etrisation}
...
\subsection{3.6. Couverture : Greeks, erreur de hedging, d\'ecision s\'equentielle}
...
\subsection{3.7. Portefeuille \& risque : m\'etriques, attribution, allocation}
...
\subsection{3.8. Strat\'egies et r\'egimes de volatilité : straddle, IV crush, Markov}
...
\subsection{3.9. Assistance et limites}
...
\begin{itemize}
  \item \textbf{Qualit\'e des donn\'ees et microstructure} :
        mod\'eliser explicitement bid--ask, slippage, latences et synchronisation spot/options, et mesurer l'impact sur
        calibration, backtests et risque.
